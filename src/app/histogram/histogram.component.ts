...
export class HistogramComponent implements OnInit, AfterViewInit {
  private data: EventData[] = [
    { date: '2023-07-01', event: 'Event A', frequency: 10 },
    { date: '2023-07-02', event: 'Event B', frequency: 20 },
    { date: '2023-07-03', event: 'Event C', frequency: 15 },
    { date: '2023-07-04', event: 'Event A', frequency: 30 },
    { date: '2023-07-05', event: 'Event B', frequency: 25 },
    { date: '2023-07-06', event: 'Event C', frequency: 5 },
    { date: '2023-07-07', event: 'Event A', frequency: 40 },
    { date: '2023-07-08', event: 'Event B', frequency: 35 },
    { date: '2023-07-09', event: 'Event C', frequency: 10 }
  ];
  ...
  private drawBars(data: EventData[]): void {
    ...
    this.svg.selectAll('rect.bar')
      ...
      .append('rect')
      .attr('class', 'bar')
      .attr('x', (d: EventData) => x(d.date)!)
      .attr('y', (d: EventData) => y(d.frequency))
      .attr('width', x.bandwidth())
      .attr('height', (d: EventData) => this.height - y(d.frequency))
      .attr('fill', (d: EventData) => this.colors(d.event));
  }
